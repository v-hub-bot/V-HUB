...
def send_featured_email(to_email, to_name, business_name, image_url, preview_to=None):
    recipient = preview_to if preview_to else to_email
    subject = f"Your FREE Featured Ad on V-HUB — {business_name}" if not preview_to else f"📋 PREVIEW — Featured Ad Email for {business_name}"
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center" style="padding:10px 0 24px 0;">
                  <img src="{image_url}" width="500" alt="{business_name} Ad" style="display:block;max-width:100%;border-radius:6px;box-shadow:0 2px 8px rgba(0,0,0,0.15);" />
                </td>
              </tr>
            </table>
...
# Send preview to Kimberly first
send_featured_email(
    to_email="tropicalsplashpainting@gmail.com",
    to_name="Dan Southcott",
    business_name="Tropical Splash Painting Power Washing & More",
    image_url="https://base44.app/api/apps/69d062aca815ce8e697894b1/files/mp/public/69d062aca815ce8e697894b1/7365fdd08_tropical_splash_final.jpg",
    preview_to="kimberlycook1980@gmail.com"
)
