...
html = """<div style="font-family:Georgia,serif;max-width:600px;margin:0 auto;background:#fdf6e3;padding:32px;border:1px solid #ddd;">
...
<h2 style="color:#1B3D6F;">Welcome to V-HUB, Cart Medic!</h2>
<p style="color:#333;font-size:15px;">Great news — your business is now listed on <strong>V-HUB</strong>, The Villages' local services directory! Residents across all of The Villages can now find and contact you directly.</p>
...
<div style="background:#fff;border:1px solid #ddd;border-radius:8px;padding:16px;margin:16px 0;">
  <p style="margin:4px 0;"><strong>VH Number:</strong> VH-2540</p>
  <p style="margin:4px 0;"><strong>Email:</strong> cart-medic@outlook.com</p>
...
<p style="color:#333;font-size:15px;">We recommend logging in and changing your password when you get a chance. If you have any questions, just reply to this email.</p>
...
payload = {
    "personalizations": [{"to": [{"email": "cart-medic@outlook.com", "name": "Cart Medic"}]}],
    "from": {"email": "admin@v-hub.us", "name": "V-HUB Directory"},
    "subject": "Welcome to V-HUB — Your Free Listing is Live!",
