...
export default function Home() {
  ...
  const SVCS_STATIC = [
    ...
    { id: "69d1822df3b2afb229b5bafc", category_id: "69d09c14d5ee9e7be9aa301f", name: "Hair Stylists / Barbers" },
