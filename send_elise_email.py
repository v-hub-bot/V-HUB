            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center" style="padding:10px 0 24px 0;">
                  <img src="https://base44.app/api/apps/69d062aca815ce8e697894b1/files/mp/public/69d062aca815ce8e697894b1/977cb26a1_elise_final.jpg" width="500" alt="Elise's Mobile Notary Ad" style="display:block;max-width:100%;border-radius:6px;box-shadow:0 2px 8px rgba(0,0,0,0.15);" />
                </td>
              </tr>
            </table>
...
for recipient in ["elisac06@aol.com", "kimberlycook1980@gmail.com"]:
    payload = json.dumps({
        "personalizations": [{"to": [{"email": recipient}]}],
        "from": {"email": "admin@v-hub.us", "name": "The V-Hub Team"},
        "reply_to": {"email": "admin@v-hub.us", "name": "The V-Hub Team"},
        "subject": "Your FREE Featured Ad on V-HUB — Elise's Mobile Notary",
