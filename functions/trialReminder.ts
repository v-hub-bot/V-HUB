...
function emailFooter() {
  return `<div style="background:#1A0A00;padding:12px;text-align:center;color:rgba(245,232,204,0.5);font-size:11px;">V-Hub · The Villages, Florida · <a href="mailto:admin@v-hub.us" style="color:#C9973A;">admin@v-hub.us</a></div>`;
}
