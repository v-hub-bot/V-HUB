...
{"business_name": "FLI Irrigation", "phone": "352-504-7827"},
{"business_name": "Florida Couriers — The Villages", "phone": "800-481-4290"},
...
{"business_name": "Gaelynn's Home Care Transport", "phone": "352-391-6200"},
...
{"business_name": "Sharon's Home Arts & Crafts", "phone": ""},
...
{"business_name": "V-Hub Test Provider", "phone": "352-000-0000"},
...
{"business_name": "Village Neighbor", "phone": ""},
...
{"business_name": "Villages Auto Detail", "phone": ""},
...
{"business_name": "Villagers Home Watch", "phone": "352-386-0444"},
...
{"business_name": "Villages Go, The", "phone": "407-225-3303"},
...
{"business_name": "William's Golf & Cart Services", "phone": ""},
...
# Write CSV
with open('/app/VHub_Provider_Directory.csv', 'w') as f:
    f.write("Business Name,Phone Number\n")
    for i, p in enumerate(providers_sorted, 1):
        name = p['business_name'].replace('"', '""')
        phone = p['phone'] if p['phone'] else "No phone listed"
        f.write(f'"{name}","{phone}"\n')

print(f"Total providers: {len(providers_sorted)}")
